...
export const approachPageEn: SiteDictionary["approachPage"] = {
  hero: {
    eyebrow: "Approach",
    title: "From meaning to structure — from structure to action in the interface",
    subtitle:
  ...
  whatWeAnalyzeSection: {
    sectionTitle: "What we unpack before we build",
    sectionIntro:
      "Skip this and you get beautiful irrelevance.",
    items: [
      {
        title: "Model & decision bar",
        text:
  ...
  fitSection: {
    sectionTitle: "Fit",
    fitsTitle: "When this approach matches",
    notFitsTitle: "When we are probably not the match",
    fits: [
      {
        title: "You need strength, not a default theme",
        text:
          "Brand, product, or company outgrew template-market websites for business and need structure plus character online.",
      },
      {
        title: "You will engage on meaning",
        text:
      ...
      {
        title: "Horizon beyond “ship and vanish”",
        text:
  ...
  closingCtaSection: {
    sectionTitle: "If you need logic, not wallpaper",
    sectionText:
    ...
    primaryCta: "Align on the brief",
    secondaryCta: "View services",
    helperText:
      "Start with a short context note or the on-site brief — we will suggest how to talk next, without a forced pitch.",
  },
  microcopy: {
    smallBadge: "ZMA Resulting approach",
    sectionDividerLabel: "How we work",
    ctaHelper: "Services and formats live on their own page; here it is only the thinking model.",
    closingLine: "Meaning → structure → action in the interface.",
  },
  seo: {
    pageMetaTitle: "Approach — ZMA Resulting | structured website, digital system",
    pageMetaDescription:
      "How ZMA Resulting builds: meaning to structure, UI, launch, and growth. Custom digital experience, workflow automation, SEO foundation — systems thinking, not template churn.",
  },
};
