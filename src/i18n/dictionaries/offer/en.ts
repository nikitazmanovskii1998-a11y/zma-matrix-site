...
export const offerPageEn: SiteDictionary["offerPage"] = {
  hero: {
    eyebrow: "Legal",
  ...
  sections: {
    ...
    servicesScope: {
      title: "3. Services (illustrative scope)",
      body:
    ...
    howRequestWorks: {
      title: "4. Site inquiries and starting work",
      body:
    ...
    termsAndDeliveryLogic: {
      title: "6. Timeline, phases, acceptance",
      body:
    ...
    modificationOfTerms: {
      title: "11. Changes to this offer",
      body:
    ...
    contactDetails: {
      title: "13. Contractor contacts",
      body: "For contractual correspondence and requisites:",
      bullets: [
  ...
  microcopy: {
    ...
    openingPageAcceptsTerms: {
      strict:
        "Opening this offer page confirms you have reviewed how contracts are formed and how liability is limited under these terms.",
      neutral:
        "Reading the offer means you understand services are scoped individually.",
      brand:
        "ZMA Resulting runs on clarity: the offer is the frame; the project brief defines the build.",
    },
    siteUseConsent: {
      strict:
        "Using the site implies lawful, fair use and awareness that ordering services follows these terms once a contract is formed.",
      neutral:
        "Use the site responsibly; service purchases follow the offer once agreed.",
      brand:
        "The site is an entry point — rules of engagement land in writing and invoices.",
    },
    formSubmitConsent: {
      strict:
        "Submitting a form is not acceptance of the offer and does not create a contract without further agreement and/or payment.",
      neutral:
        "Forms start a conversation, not automatic work.",
      brand:
        "A form opens the thread — scope, time, and fee follow in dialogue.",
    },
    lastUpdatedPhrase: {
      strict: "Offer last updated:",
      neutral: "Last update of this offer:",
      brand: "Offer version date:",
    },
    contactDataProcessing: {
      strict: "Personal data questions belong under the privacy policy.",
      neutral: "For data handling, see the privacy policy.",
      brand: "Privacy details live in the site’s privacy policy.",
    },
    contactServiceTerms: {
      strict: "Service terms: zmanovsckynikita@yandex.ru or +7 928 308-66-86.",
      neutral: "Discuss services and this offer via email or phone in the site footer.",
      brand: "Talk terms on email or Telegram @zma_resulting.",
    },
  },
  seo: {
    pageMetaTitle: "Public offer — ZMA Resulting",
    pageMetaDescription:
      "Terms for ZMA Resulting digital services: custom websites, digital environments, Telegram, automation, SEO foundations. Russian IE registration details on page.",
  },
};
